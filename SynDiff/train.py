...
def train_syndiff(rank, gpu, args):
    ...
    gen_diffusive_2.load_state_dict(
        torch.load(os.path.join(exp_path, 'gen_diffusive_2_{}.pth'.format(30)), map_location=device))
    gen_non_diffusive_1to2.load_state_dict(
        torch.load(os.path.join(exp_path, 'gen_non_diffusive_1to2_{}.pth'.format(30)), map_location=device))
    gen_non_diffusive_2to1.load_state_dict(
        torch.load(os.path.join(exp_path, 'gen_non_diffusive_2to1_{}.pth'.format(30)), map_location=device))
    # disc_diffusive_1.load_state_dict(torch.load('', map_location=device))
    disc_diffusive_2.load_state_dict(
        torch.load(os.path.join(exp_path, 'disc_diffusive_2_{}.pth'.format(30)), map_location=device))
    disc_non_diffusive_cycle1.load_state_dict(
        torch.load(os.path.join(exp_path, 'disc_non_diffusive_cycle1_{}.pth'.format(30)), map_location=device))
    disc_non_diffusive_cycle2.load_state_dict(
        torch.load(os.path.join(exp_path, 'disc_non_diffusive_cycle2_{}.pth'.format(30)), map_location=device))
    ...
    for epoch in range(init_epoch, args.num_epoch+1):
        ...
        #         torchvision.utils.save_image(x2_pos_sample, os.path.join(exp_path, 'xpos2_epoch_{}.png'.format(epoch)), normalize=True)
            ...
            if epoch % args.save_ckpt_every == 0:
                ...
                torch.save(gen_diffusive_2.state_dict(), os.path.join(exp_path, 'gen_diffusive_2_{}.pth'.format(epoch+320)))
                torch.save(gen_non_diffusive_1to2.state_dict(), os.path.join(exp_path, 'gen_non_diffusive_1to2_{}.pth'.format(epoch+320)))
                torch.save(gen_non_diffusive_2to1.state_dict(), os.path.join(exp_path, 'gen_non_diffusive_2to1_{}.pth'.format(epoch+320)))

                torch.save(disc_diffusive_2.state_dict(), os.path.join(exp_path, 'disc_diffusive_2_{}.pth'.format(epoch+320)))
                torch.save(disc_non_diffusive_cycle1.state_dict(), os.path.join(exp_path, 'disc_non_diffusive_cycle1_{}.pth'.format(epoch+320)))
                torch.save(disc_non_diffusive_cycle2.state_dict(), os.path.join(exp_path, 'disc_non_diffusive_cycle2_{}.pth'.format(epoch+320)))
