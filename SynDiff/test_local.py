...
def sample_and_test(args):
	...
	for iteration, (x, y) in enumerate(data_loader):
		...
		fake_sample2 = fake_sample2 / fake_sample2.max()
		# real_data = to_range_0_1(real_data) ; real_data = real_data/real_data.max()
		# source_data = to_range_0_1(source_data); source_data = source_data/source_data.max()
		...
		torchvision.utils.save_image(fake_sample2.permute(0, 1, 3, 2),
		                             '{}/{}_samples2_{}.jpg'.format(save_dir, phase, iteration), normalize=True)
...
if __name__ == '__main__':
	...
	parser.add_argument('--which_epoch', type=int, default=631)
	...
	# print('epoch-{} | FID-{}'.format(args.which_epoch, fid))

	# calculate_average_lpips('./dataset/MR/', './output/exp_syndiff/generated_samples/lpips/')
