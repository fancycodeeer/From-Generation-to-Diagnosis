...
def get_args():
    ...
    parser.add_argument('--patience', type=int, default=50, help='Early-stopping patience based on case-level Dice')
    parser.add_argument('--min_delta', type=float, default=0.000, help='Minimum Dice improvement for early stopping')
