...
parser.add_argument('--generator_A2B', type=str, default='D:/CT2MR/T1_output/Pix2pix+FDIT/299_netG_A2B.pth', help='A2B generator checkpoint file')
parser.add_argument('--generator_B2A', type=str, default='D:/CT2MR/T1_output/Pix2pix+FDIT/299_netG_B2A.pth', help='B2A generator checkpoint file')
parser.add_argument('--output_dir', type=str, default='D:/CT2MR/Stat_significance/T1_output/p2p+fdit/')
...
#     os.makedirs('./logs/MR/')
# if not os.path.exists('./output_CHAOS/A'):
#     os.makedirs('./output_CHAOS/A')
# if not os.path.exists('./output_CHAOS/B'):
#     os.makedirs('./output_CHAOS/B')
...
for i, batch in enumerate(dataloader):
    ...
    # save_image(fake_A, './output_CHAOS/A/' + name_A)
    # save_image(fake_B, './output_CHAOS/B/' + name_B)
