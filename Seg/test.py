...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint", type=str, default='./checkpoints/cvpr18/best_model_57.pth', help="训练好的模型权重文件路径")
    parser.add_argument("--output_dir", type=str, default="./output/cvpr18", help="分割结果保存目录")
